...
function LikesModalComp({ onClose }) {
  const postData = {
    ...
    postImage:
      "https://media.istockphoto.com/id/649356542/photo/adventurous-people-making-ascent-to-high-mountain-walking-on-glacier.jpg?s=2048x2048&w=is&k=20&c=9DT0JR9qlhdI2dfFHKQ5V7vuIRYb0AilSk7y_c1EmpE=",
    techStack: ["React", "Antd", "Mongo DB", "Firebase", "gohoi", "hhgaoag"],
    caption:
      "Lorem ipsum dolor sit amet consectetur, adipisicing elit. A, rem maiores dolorum possimus delectus necessitatibus nemo itaque libero voluptatem fugit loreanong bohghang  sdnjbgkkd  hoisgonn  agboan",
    ...
    >
      <div className="flex flex-col justify-start dark:bg-[#242526] bg-white rounded-lg w-[22rem] h-[19rem] pl-3 py-3">
        <div className="flex flex-col items-center justify-center relative dark:text-white text-gray-800 gap-1 pr-3">
          ...
          <i
            onClick={onClose}
            className=" absolute right-0 -top-[0.4rem] bx bx-x text-3xl cursor-pointer"
          ></i>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="dark:text-gray-500 text-gray-400 text-sm -mt-1">
                    {like.username}
                  </span>
                </div>
              </div>
              <div>
                <button className="bg-[#695CFE] text-sm tracking-wide px-2 py-1 rounded-lg text-white hover:bg-[#5E52E3] active:scale-[0.95] active:bg-[#695CFE]">
                  Connect
                </button>
              </div>
            </div>
